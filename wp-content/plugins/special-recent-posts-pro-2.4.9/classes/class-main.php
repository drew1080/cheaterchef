...
*/
	...
	*/
	static function visualizationCheck($instance, $call) {
		...
		} else if ( (isset($new_instance["vf_home"])) && ($new_instance["vf_home"] == 'yes') && (is_home() || is_front_page()) ){
			return true;
...
*/
	...
	*/
	public function displayPosts($widget_call = NULL, $return_mode) {
		...
		$srp_content  = "<!-- BOF Special Recent Posts PRO Edition ver" . SRP_PLUGIN_VERSION . " -->";
				...
				if ($this->widget_args["widget_title_link"] != "") {
					...
					switch ($this->widget_args["post_status"]) {
						...
						case "trash":
							...
							$srp_content .= $this->srp_create_tag('h3', $widget_title_link, array('class' => 'widget-title srp-widget-title'));
		...
		$srp_content .= "<!-- EOF Special Recent Posts PRO Edition ver" . SRP_PLUGIN_VERSION . " -->";
