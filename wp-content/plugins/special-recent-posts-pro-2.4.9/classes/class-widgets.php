	...
	<dl class="srp-wdg-accordion">
		...
		<dd class="srp-widget-optionlist-dd-credits">
			<ul class="srp-widget-optionlist-credits srp-widget-optionlist">
				...
				<!-- BOF Credits Text. -->
				<li>
					<?php _e('<p>The <strong>Special Recent Posts PRO Edition</strong> plugin is created, developed and supported by <a href="http://www.lucagrandicelli.com" title="Luca Grandicelli Website">Luca Grandicelli</a></p><strong>SRP Version: ' . SRP_PLUGIN_VERSION . '</strong>', SRP_TRANSLATION_ID); ?>
				</li>
				<!-- EOF Credits Text. -->
			</ul>
		</dd>
