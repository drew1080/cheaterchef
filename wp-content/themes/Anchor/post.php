...
<div class="entry-content">
 <?php
    global $post;
    $post_images = bdw_get_images_anchor($post->ID,'detail-page-thumb');
...
?>
<?php echo apply_atomic_shortcode( 'entry_meta', '<div class="entry-meta">' . __( 'Category: [entry-terms taxonomy="category"] [entry-terms taxonomy="post_tag" before="and Tagged: "]', T_DOMAIN ) . '</div>' ); ?>
